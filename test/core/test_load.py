...
class TestInitSuPy(TestCase):
    ...
    def setUp(self):
        ...
        self.sample_config = Path(sp.__file__).parent / "sample_run" / "sample_config.yml"
        self.benchmark_config = Path(__file__).parent.parent / "fixtures" / "benchmark1" / "benchmark1.yml"
...
class TestLoadForcing(TestCase):
    ...
    def test_load_forcing_grid_sample(self):
        ...
        print(f"✓ Loaded forcing with {len(df_forcing)} timesteps and {len(df_forcing.columns)} columns")
    ...
    def test_load_sample_data(self):
        ...
        print(f"✓ Loaded sample data: {len(df_state)} grids, {len(df_forcing)} timesteps")
...
class TestErrorHandling(TestCase):
    ...
    def test_invalid_file_paths(self):
        ...
        with self.assertRaises((FileNotFoundError, ValueError, RuntimeError, AttributeError)):
