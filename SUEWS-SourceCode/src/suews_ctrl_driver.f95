...
CONTAINS
   ...
   SUBROUTINE SPARTACUS( &
      ...
      clear_air_abs_lw_spc = lw_flux%clear_air_abs(nspec, :)
      wall_net_lw_spc = 0.0
      wall_net_lw_spc = lw_flux%wall_net(nspec, :)
      roof_net_lw_spc = 0.0
      roof_net_lw_spc = lw_flux%roof_net(nspec, :)
      roof_in_lw_spc = 0.0
      roof_in_lw_spc = lw_flux%roof_in(nspec, :)
      ...
      clear_air_abs_sw_spc = sw_flux%clear_air_abs(nspec, :)
      wall_net_sw_spc = 0.0
      wall_net_sw_spc = sw_flux%wall_net(nspec, :)
      roof_net_sw_spc = 0.0
      roof_net_sw_spc = sw_flux%roof_net(nspec, :)
      roof_in_sw_spc = 0.0
      roof_in_sw_spc = sw_flux%roof_in(nspec, :)
