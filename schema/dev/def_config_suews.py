...
class BuildingLayer(BaseModel):
    ...
    def to_df_state(
        ...
        # Sort and concatenate DataFrames if we have any
        if dfs:
            for df in dfs:
        ...
        # Return empty DataFrame if no specific properties were added
        return pd.DataFrame(index=pd.Index([grid_id], name="grid"))
