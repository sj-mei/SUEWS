...
class SUEWSConfigEditor(Directive):
    ...
    def run(self):
        ...
        scripts = [
            nodes.raw('', '<script type="module" crossorigin src="_static/suews-config-ui/main.js"></script>', format='html'),
            nodes.raw('', '<link rel="stylesheet" href="_static/suews-config-ui/main.css">', format='html')
        ]
