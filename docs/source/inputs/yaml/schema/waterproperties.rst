...
.. option:: waterdist <WaterDistribution (Optional)>

   Water distribution parameters

   :Default: Not specified

   For ``waterdist``, if using the WaterDistribution structure, see :doc:`waterdistribution` for details.
...
.. option:: flowchange <RefValue[float] | float>
