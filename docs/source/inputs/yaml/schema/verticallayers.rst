...
.. option:: nlayer <RefValue[int] | int>
...
.. option:: height <RefValue[List[float]] | List of float>
...
.. option:: veg_frac <RefValue[List[float]] | List of float>
...
.. option:: veg_scale <RefValue[List[float]] | List of float>
...
.. option:: building_frac <RefValue[List[float]] | List of float>
...
.. option:: building_scale <RefValue[List[float]] | List of float>
