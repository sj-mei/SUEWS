...
.. option:: faidectree <RefValue[float] | float>
...
.. option:: dectreeh <RefValue[float] | float>
...
.. option:: pormin_dec <RefValue[float] | float>
...
.. option:: pormax_dec <RefValue[float] | float>
...
.. option:: capmax_dec <RefValue[float] | float>
...
.. option:: capmin_dec <RefValue[float] | float>
