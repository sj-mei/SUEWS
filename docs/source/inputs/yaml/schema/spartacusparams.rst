...
.. option:: air_ext_lw <RefValue[float] | float>
...
.. option:: air_ext_sw <RefValue[float] | float>
...
.. option:: air_ssa_lw <RefValue[float] | float>
...
.. option:: air_ssa_sw <RefValue[float] | float>
...
.. option:: ground_albedo_dir_mult_fact <RefValue[float] | float>
...
.. option:: n_stream_lw_urban <RefValue[int] | int>
...
.. option:: n_stream_sw_urban <RefValue[int] | int>
...
.. option:: n_vegetation_region_urban <RefValue[int] | int>
...
.. option:: sw_dn_direct_frac <RefValue[float] | float>
...
.. option:: use_sw_direct_albedo <RefValue[float] | float>
...
.. option:: veg_contact_fraction_const <RefValue[float] | float>
...
.. option:: veg_fsd_const <RefValue[float] | float>
...
.. option:: veg_ssa_lw <RefValue[float] | float>
...
.. option:: veg_ssa_sw <RefValue[float] | float>
