...
def main():
    ...
    try:
        ...
        print(f"ERROR: Could not import SUEWSConfig. Make sure supy is installed or add src to PYTHONPATH.")
    ...
    schema["description"] = "JSON Schema for SUEWS (Surface Urban Energy and Water balance Scheme) configuration"
